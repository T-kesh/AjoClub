        ...
        {isMiniPay ? (
          ...
          <>
            ...
            <div className="rounded-2xl border border-gray-200 bg-gray-50 p-4 text-center">
              <p className="text-sm text-gray-500 mb-1 font-medium">Want to create or join a club?</p>
              <p className="text-xs text-gray-400">Open this app inside the <span className="font-semibold text-gray-500">MiniPay</span> wallet to transact.</p>
            </div>
            <div className="flex flex-col gap-1 text-center pt-2">
              <p className="text-xs text-gray-400">Built on Celo · Powered by Mento stablecoins</p>
              <a
                href="https://celoscan.io/address/0x95cB4aA0b634D02E218B2ae2b85B464007c3457c"
                target="_blank"
