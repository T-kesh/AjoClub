  ...
  return (
    <main className="max-w-md mx-auto p-6">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-xl font-bold text-gray-900 dark:text-gray-100">All Clubs</h1>
        {isMiniPay && (
          <Link href="/create">
      ...
      {!isMiniPay && (
        <div className="rounded-2xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 p-3 mb-5 text-center">
          <p className="text-xs text-gray-400 dark:text-gray-500">
            Viewing in read-only mode — open in <span className="font-semibold text-gray-500 dark:text-gray-400">MiniPay</span> to create or join clubs.
          </p>
        </div>
      )}

      {isLoading && <p className="text-center text-gray-400 dark:text-gray-500 mt-10">Loading…</p>}

      {!isLoading && ids.length === 0 && (
        <div className="text-center mt-16">
          <p className="text-gray-400 dark:text-gray-500 mb-4">No clubs yet.</p>
          {isMiniPay && (
            <Link href="/create">
